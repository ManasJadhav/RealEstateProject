      ...
      <section className="flex flex-col justify-left lg:w-7/12 lg:mx-auto mx-4 my-10 shadow-xl h-fit bg-white rounded-3xl p-8 relative ">
        ...
        <ul className="list-disc text-justify p-3 text-lg">
          <li className="p-1.5">
            ...
            installation, leakage fixing, tile setting, floor laying, Outdoor
            modeling, waterproofing and more.
          </li>
          <li className="p-1.5">
            We will customize our professional services to fit your specific
            need. Job transferred and need to make your home ready to rent? We
            will take care of it for you.
          </li>
          <li className="p-1.5">
            Need to remake your home before your move back in? We are on the
            job.
          </li>
          <li className="p-1.5">
            We also provide end-to-end management of rental properties. From
            cleaning and upkeep to regular fixes in the house, we will see to
            everything to keep your home in the best possible condition.
          </li>
          <li className="p-1.5">
