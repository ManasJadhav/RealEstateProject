...
import SharePop from "./sharepopup";
...
function Body() {
  ...
  return (
    <div className="bg-body bg-[url('/body-img2.png')] lg:grid lg:grid-cols-3 lg:pt-20 min-h-screen ">
      {/* <div className="absolute lg:top-28 top-20">
        <Marquee className="z-10 bg-[#072960] text-white">
          <a className="font-bold text-xl tracking-widest" href="/service">
            ...
            --------- -------- Buy/Sell Residential Property and Commercial
            Properties ---------
          </a>
        </Marquee>
      </div> */}
        ...
        <div className="lg:absolute lg:top-32 lg:left-11 lg:bottom-0 bottom-8 lg:pl-8">
          ...
          <div className="flex lg:mt-20 mt-14 ">
            ...
            >
              ...
              {!clicked ? <h1>Share</h1> : <h2>Close</h2>}
            </button>
